        ...
        if (btnAStt == false) {
            ...
            if (cbbType.getSelectedIndex() == 0) {
                ...
                if (name.isEmpty()) {
                    ...
                    JOptionPane.showMessageDialog(null, "Nhập tên là chữ cái");
                    txtName.requestFocus();
                } else if (name.trim().length() > 30) {
                    JOptionPane.showMessageDialog(null, "Tên không nhiều hơn 30 kt");
                    txtName.requestFocus();
                } else if (price < 1) {
                    JOptionPane.showMessageDialog(null, "Gía là số dương");
                    spPrice.requestFocus();
                } else if (des.isEmpty()) {
                    JOptionPane.showMessageDialog(null, "Nhập ghi chú");
                    txtaDes.requestFocus();
                } else if (!Pattern.compile("[a-z ._]+", Pattern.CASE_INSENSITIVE).matcher(des).matches()) {
                    JOptionPane.showMessageDialog(null, "Ghi chú là chữ cái");
                    txtaDes.requestFocus();
            ...
            if (cbbType.getSelectedIndex() == 1) {
                initModelf();
                if (name.isEmpty()) {
                    JOptionPane.showMessageDialog(null, "Nhập đủ");
                    txtName.requestFocus();
                } else if (!Pattern.compile("[a-z ._]+", Pattern.CASE_INSENSITIVE).matcher(name).matches()) {
        ...
        if (i > -1) {
            if (btnAStt == false) {
                ...
                if (cbbTypeS.getSelectedIndex() == 1) {
                    if (name.isEmpty()) {
                        JOptionPane.showMessageDialog(null, "Nhập têm");
                        txtName.requestFocus();
                    } else if (!Pattern.compile("[a-z ._]+", Pattern.CASE_INSENSITIVE).matcher(name).matches()) {
                        JOptionPane.showMessageDialog(null, "Tên phải là chữ cái");
                        txtName.requestFocus();
                    } else if (name.trim().length() > 30) {
                        JOptionPane.showMessageDialog(null, "Tên không dài hơn 30 ký tự");
                        txtName.requestFocus();
                    } else if (price < 1) {
                        JOptionPane.showMessageDialog(null, "Gía phải là số dương");
                        spPrice.requestFocus();
                    } else if (des.isEmpty()) {
                        JOptionPane.showMessageDialog(null, "Nhập mô tả");
                        txtaDes.requestFocus();
                    } else if (!Pattern.compile("[a-z ._]+", Pattern.CASE_INSENSITIVE).matcher(des).matches()) {
                        JOptionPane.showMessageDialog(null, "Ghi chú phải là chữ cái");
                        txtaDes.requestFocus();
                    } else if (des.trim().length() > 200) {
                        JOptionPane.showMessageDialog(null, "Ghi chú không nhiều hơn 200 ký tự");
                        txtaDes.requestFocus();
                    } else {
                ...
                if (cbbTypeS.getSelectedIndex() == 2) {
                    if (name.isEmpty()) {
                        ...
                        if (idi.updateTan(d)) {
                            ...
                            JOptionPane.showMessageDialog(null, "Thát bại");
                        }
                    }
                }
            }
