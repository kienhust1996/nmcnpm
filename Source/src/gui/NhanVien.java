...
public class NhanVien extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(51, 51, 255)), "TÌM NHÂN VIÊN", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(51, 51, 255))); // NOI18N
        ...
        jPanel4.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(51, 51, 255)), "NHÂN VIÊN", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(51, 51, 255))); // NOI18N
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        ...
        if ((name.length() == 0) || (dob == null) || (contact.length() == 0)) {
            ...
            entities.Employee e = new entities.Employee(1, name, position, contact, dob, jday);
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        ...
        if ((name.length() == 0) || (dob == null) || (contact.length() == 0)) {
            ...
            entities.Employee e = new entities.Employee(iid, name, position, contact, dob, dob);
            IEmployeeImpl ei = new IEmployeeImpl();
            if (ei.update(e)) {
    ...
    private void initModel() {
        ...
        model.setRowCount(0);
        IEmployeeImpl ei = new IEmployeeImpl();
        for (entities.Employee e : ei.getList()) {
            int iid = e.getEmployeeID();
            String name = e.getEmployeeName();
            Date dob = e.getDOB();
            String position = e.getPosition();
            String contact = e.getContact();
            entities.Employee em = new entities.Employee(iid, name, position, contact, dob, dob);
